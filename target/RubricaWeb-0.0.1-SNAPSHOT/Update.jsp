...
<table>
	...
	<p>
			Inserisci l'id: <input type="text" name="idup">
    </p>
    <p>
			Inserisci il nome: <input type="text" name="nomeup">
    </p>
    <p>
			Inserisci il cognome: <input type="text" name="cognomeup">
	</p>
